# Задание №11. Задача о максимальном потоке минимальной стоимости. Варинат 5
...
Укажем начальный поток величиной 9 s -> с -> t. Первое число - реальный поток, второе - пропускная способность.
...
| Стоимость транспортировки единицы потока c(e) | 3  | 3  | 3  | 12 | 3  | 8  | 3  |  2 |        |
| Суммарная стоимость f(e)*c(e)                 | 27 | 27 | 15 | 84 | 12 | 48 | 15 | 22 |**250** |

Ответ: Следовательно максимальный поток в сети равен 18, минимальная стоимость равна 250

Она реализуется следующими локальными потоками:
