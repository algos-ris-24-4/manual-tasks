...
В ячейке A5 появилось новое нулевое значение, добавим соответствующее ребро в двудольный граф. Также удаляем ребра E1 и C1. Но у вершины E1 теперь нет ребер, поэтому проведем редукцию по строке. 
...
Теперь у вершины E также есть ребра - E1 и E3. Добавим и уберем все, что нужно, в графе
...
graph LR
    ...
    style 1 fill:#008000
```
Мы нашли непокрытую вершину 3 в 1 фронте в цепи E - 3.
...
graph LR
    ...
    style 3 fill:#008000
```
Теперь построим граф с учетом новых покрытых вершин
